...
function Description(props) {
	...
	const element = (
		create('div', { className: 'content' },
			create('div', { className: 'content_header' },
				create('div', { className: 'content_header-caption' },
					...
					create('div', { className: 'content_header-section' },
						...
						Item('Speed', Object.keys(props.speed).map(key => `${key} ${props.speed[key]}`).join(', ')),
					),
				),
			),
			...
			create('section', { className: 'section' },
				Item('Damage Resistances', props.damage_resistances.join(', ') || 'none'),
				Item('Damage Immunities', props.damage_immunities.join(', ') || 'none'),
